...
export default function Disclaimer() {
  return <PageShell title="면책 안내" description="생활비랩에서 제공하는 생활비·생활 정보의 이용 범위와 확인이 필요한 사항을 안내합니다." path="/disclaimer">
    <section className="service-hero service-hero--ink"><div className="content-wrap"><p className="eyebrow">생활비랩 면책 안내</p><h1>정보를 읽은 뒤에는<br /><span>내 상황에 맞게</span> 확인하세요.</h1><p>생활비랩은 생활비와 생활 정보 이해를 돕기 위한 일반적인 안내를 제공합니다. 개별 상황에 대한 전문적인 판단이나 결과를 보장하지 않습니다.</p></div></section>
